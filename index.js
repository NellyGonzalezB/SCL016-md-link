...
const FileOrDirectory = (Path) => {
  ...
  return new Promise((resolve, rejects) => {
    ...
    // stat return information about the given file or directory, returns an object
      if (err) {
        rejects(error)
...
const readDirectorys = (dirPath) => {
  return new Promise((resolve, reject) => {
    ...
    files.forEach((archive, i) => {
      directoryContent[i] = FileOrDirectory(dirPath + '/' + archive)
    });
...
//Recibe ruta y verfica si es un archiveivo o directorio
